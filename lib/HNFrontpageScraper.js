...
page.open('https://news.ycombinator.com', function () {
  page.includeJs('http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js', function() {
    page.includeJs('http://ajax.cdnjs.com/ajax/libs/underscore.js/1.4.2/underscore-min.js', function() {
      ...
      page.evaluate(function (patterns) {
        ...
        console.log(JSON.stringify({ matches: matches, HNCommentPages: HNCommentPages, articles: articles }));
